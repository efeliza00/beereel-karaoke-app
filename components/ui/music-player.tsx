...
export interface MusicPlayerProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  autoPlay?: boolean;
  /** Controlled playing state — when defined, playback is externally controlled */
  playing?: boolean;
  /** Mute the audio output (e.g., guests listening to the host's speaker) */
  muted?: boolean;
}
...
export function MusicPlayer({
  ...
  }, [isPlaying, youtubeId, isControlled]);
