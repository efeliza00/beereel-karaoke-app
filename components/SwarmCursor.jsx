...
const SwarmCursor = ({
  ...
  // Keep latest props available inside long-lived handlers without
  // re-initialising the WebGL renderer. Runs after every render, and because
  // it is declared before the renderer effect below, props are populated
  // before the render loop first reads them.
  useEffect(() => {
    propsRef.current = {
      color,
      accentColor,
